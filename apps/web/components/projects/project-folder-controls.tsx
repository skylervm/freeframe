...
function FolderNode({ folder, folders, projects, placements, userId, viewMode, onManage, onMoveProject, onUpdated }: { folder: ProjectFolder; folders: ProjectFolder[]; projects: Project[]; placements: PersonalProjectPlacement[]; userId?: string; viewMode: "grid" | "list"; onManage: (folder: ProjectFolder) => void; onMoveProject: (project: Project) => void; onUpdated: () => void; }) {
