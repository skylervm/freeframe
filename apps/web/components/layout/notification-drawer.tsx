...
export function NotificationDrawer({ open, onClose }: NotificationDrawerProps) {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 right-0 bottom-0 left-0 z-40 md:left-[52px]" onClick={onClose} />

      {/* Drawer */}
      <div className="fixed left-0 top-0 z-50 h-full w-full border-r border-border bg-bg-primary shadow-2xl flex flex-col animate-in slide-in-from-left-2 duration-150 md:left-[52px] md:w-[380px]">
        {/* Header */}
